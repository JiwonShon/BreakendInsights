...
# 
################################################################################
# check for empty file of breakpoins_bed due to non-existing discordant positions
if (file.size(opt$breakpoints_bed) == 0) {
  message("breakpoints_bed file is empty. Creating empty output files.")

  empty_df <- data.frame()

  svaba_filename <- basename(opt$svaba_sv_vcf)
  
  write_tsv(empty_df, paste0(opt$output_path, svaba_filename, "_matched_svaba_annotated_aa.tsv"), na = "")
  write_tsv(empty_df, paste0(opt$output_path, svaba_filename, "_matched_svaba_aa.tsv"), na = "")
  write_tsv(empty_df, paste0(opt$output_path, svaba_filename, "_matched_unfiltered_svaba_annotated_aa.tsv"), na = "")
  write_tsv(empty_df, paste0(opt$output_path, svaba_filename, "_matched_unfiltered_svaba_aa.tsv"), na = "")
  quit(save = "no")  
}
...
write_tsv(Matched_annotated_cycle_Svaba, paste0(opt$output_path, svaba_filename, "_matched_svaba_annotated_aa.tsv"), na = "")
write_tsv(Matched_cycle_Svaba, paste0(opt$output_path, svaba_filename, "_matched_svaba_aa.tsv"), na = "")

write_tsv(Matched_annotated_cycle_Svaba_unfiltered, paste0(opt$output_path, svaba_filename, "_matched_unfiltered_svaba_annotated_aa.tsv"), na = "")
write_tsv(Matched_cycle_Svaba_unfiltered, paste0(opt$output_path, svaba_filename, "_matched_unfiltered_svaba_aa.tsv"), na = "")
